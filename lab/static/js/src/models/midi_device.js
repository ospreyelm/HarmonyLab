define([
    ...
    const disableDivToggle = ["Disable MIDI", "Enable MIDI"]
    ...
    if ($("#DisableMidi").length > 0) {
        $("#DisableMidi").click(function (){
            disableMidi = document.getElementById("DisableMidi");
            if (disableMidi.innerHTML == disableDivToggle[0]) {
                DISABLE_MIDI = true;
                disableMidi.innerHTML = disableDivToggle[1];
            }
            else {
                DISABLE_MIDI = false;
                disableMidi.innerHTML = disableDivToggle[0]
            } 
        });    
    }
